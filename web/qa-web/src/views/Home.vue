<template>
  <div class="home">
    ...
    <div class="lang-switch">
      <a-select v-model:value="locale" @change="changeLanguage" style="width: 120px">
    ...
    <section class="active-rooms">
      ...
      <p class="section-subtitle">{{ $t('home.roomSubtitle') }}</p>
